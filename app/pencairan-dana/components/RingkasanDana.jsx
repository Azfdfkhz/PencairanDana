...
export default function RingkasanDana() {
  return (
    <div className="mb-6 rounded-xl border border-gray-100 bg-white p-5 shadow-xs md:p-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-[#64748b]">Dana Terkumpul</p>
            <p className="text-lg font-bold text-[#1e293b]">Rp 213.788.000</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-[#64748b]">Sudah Dicairkan</p>
            <p className="text-lg font-bold text-[#1e293b]">Rp 213.788.000</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-[#64748b]">Bisa Dicairkan</p>
            <p className="text-lg font-bold text-[#00b96b]">Rp 190.788.000</p>
