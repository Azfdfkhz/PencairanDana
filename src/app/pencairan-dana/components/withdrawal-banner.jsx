...
export default function WithdrawalBanner() {
  return (
    <div className="mt-8 flex flex-col items-center justify-between gap-6 rounded-2xl border border-[#d2e4ff] bg-[#f0f6fe] p-5 md:flex-row md:p-6 shadow-xs">
      <div className="flex items-center gap-4 md:gap-5">
        ...
        {/* Text Content */}
        <div>
          <h3 className="text-base font-semibold text-black md:text-l">
            Salurkan Kebaikan Tanpa Menunggu
          </h3>
          <p className="mt-1 text-xs text-[#AEAEAE] md:text-xs leading-relaxed">
