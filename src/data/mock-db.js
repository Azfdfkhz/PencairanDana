...
export const campaignInfo = {
  ...
  thumbnail: "/images/campaign-rohingya.png",
...
export const withdrawalHistoryData = [
  {
    ...
    status: "Diproses",
    statusType: "warning",
    detailUrl: "/withdrawal/fund-details?id=1",
  ...
  },
  {
    ...
    status: "Ditolak",
    statusType: "danger",
    detailUrl: "/withdrawal/fund-details?id=2",
    withdrawalAmount: "Rp 190.788.000",
    distributionLocation: "Palu, Sulawesi Tengah",
    distributionDate: "30–04–2027",
    recipientCount: "150 Orang",
  ...
  },
  {
    ...
    status: "Berhasil",
    statusType: "success",
    detailUrl: "/withdrawal/fund-details?id=3",
    withdrawalAmount: "Rp 190.788.000",
    distributionLocation: "Palu, Sulawesi Tengah",
    distributionDate: "30–04–2027",
    recipientCount: "150 Orang",
  ...
  },
  {
    ...
    status: "Berhasil",
    statusType: "success",
    detailUrl: "/withdrawal/fund-details?id=4",
    withdrawalAmount: "Rp 190.788.000",
    distributionLocation: "Palu, Sulawesi Tengah",
    distributionDate: "30–04–2027",
    recipientCount: "150 Orang",
...
export function insertMockSubmission(payload) {
  ...
  const newItem = {
    ...
    status: "Diproses",
    statusType: "warning",
    detailUrl: `/withdrawal/fund-details?id=${nextMockId - 1}`,
